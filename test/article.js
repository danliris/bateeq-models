...
it("#18. ArticleProcess should valid", function () {
    var ArticleProcess = require('../src/master/article/article-process');
    validate.articleProcess(new ArticleProcess());
})

it("#19. ArticleSubProcess should valid", function () {
    var ArticleSubProcess = require('../src/master/article/article-sub-process');
    validate.articleSubProcess(new ArticleSubProcess());
})

it("#20. ArticleMaterialComposition should valid", function () {
    var ArticleMaterialComposition = require('../src/master/article/article-material-composition');
    validate.articleMaterialComposition(new ArticleMaterialComposition());
})

it("#21. ArticleSubMaterialComposition should valid", function () {
    var ArticleSubMaterialComposition = require('../src/master/article/article-sub-material-composition');
    validate.articleSubMaterialComposition(new ArticleSubMaterialComposition());
})

it("#22. ArticleCollection should valid", function () {
    var ArticleCollection = require('../src/master/article/article-collection');
    validate.articleCollection(new ArticleCollection());
})

it("#23. ArticleSubCollection should valid", function () {
    var ArticleSubCollection = require('../src/master/article/article-sub-collection');
    validate.articleSubCollection(new ArticleSubCollection());
})